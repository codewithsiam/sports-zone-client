    ...
    <>
      ...
      >
          ...
          <SwiperSlide key={cls._id}> {/* Add a unique key to each slide */}
            <div className="relative h-72">
              ...
              <div className="absolute flex items-center justify-between bottom-0 text-black w-full p-5  bg-opacity-60 bg-black">
                <div>
                  {cls?.className && (
                    <h1 className="text-white text-md md:text-2xl  font-bold">
                      {cls?.className}
                    </h1>
                  )}
                  ...
                  <p className="text-indigo-100 border">Price: ${cls?.price}</p>
                </div>
                <Link to="/allClasses">
        ...
        <SwiperSlide className="bg-indigo-200">
          <Link to="/allClasses">
            <button className="text-black text-2xl font-bold mx-auto mt-32 flex items-center justify-center gap-3">

        ...
        <footer aria-label="Site Footer" className="bg-primary mt-36">
            ...
            >
                    ...
                    <div>
                        <div className="text-white">
                            <Link to='/' className='flex items-center'>
                                <h3 className='font-bold text-2xl italic text-white '>Sports Zone</h3>
                            </Link>
                        </div>

                        <p className="max-w-xs mt-4 text-white">

                            Unleash Your Inner Champion, Connect and Excel Together!
                        </p>
                ...
                <p className="text-xs text-white text-center">
                    &copy; 2023 Sports Zone All rights reserved.
                </p>
            </div>
        </footer>
    );
